...
function FavDescription({ setCurrentSubmission, setSubmissions, setFavsubmissions, favsubmissions }) {
    const [open, setOpen] = useState(false);
    const location = useLocation();
    const { submission, id, title, summary, img, linklink, description, year, author, ISBN } = location.state;
            ...
            >
                <div className="content">
                    <div className="header">
                        <h2>Delete  Book</h2>
                        <p>This action is irreversible. Are you sure you want to delete this Book?</p>
                    </div>
                    <div>
                        <Button className='cancelButton' onClick={handleClose}>
                            Cancel
                        </Button>
                        <Button className='deleteButton' onClick={handleDeleteConfirmed}>
                            Delete
                        </Button>
                    </div>
                </div>
